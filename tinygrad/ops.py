...
class UOp(MathTrait):
  ...
  def full_shape(self) -> Tuple[sint, ...]:
    ...
    uops = [x.full_shape for x in self.src if x.op not in {UOps.DEFINE_GLOBAL, UOps.DEFINE_LOCAL, UOps.DEFINE_VAR, UOps.CONST}]
    return tuple(max(x) for x in zip(*uops))
